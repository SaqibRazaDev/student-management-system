            ...
            <div className="content flex flex-row">
                ...
                <div className="page-content px-8 md:px-12 lg:px-14 py-14 w-full">
                    ...
                    <div className="stu-bar py-14 flex justify-between">
                        ...
                        <Link href="/students/addStudent" className='bg-white hover:bg-gray-200 text-gray-800 md:font-semibold py-2 px-2 border border-gray-400 rounded shadow max-w-xs flex justify-center'>
